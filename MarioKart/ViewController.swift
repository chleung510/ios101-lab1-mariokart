...
class ViewController: UIViewController,
  ...
  //  Called when user double-taps a kart
    // This function passes in sender(GestureRecognizer object) telling the object how it should behave when tape twice
    // Without _ you have to pass in as (sender:mySender)
  @IBAction func didDoubleTapKart(_ sender: UITapGestureRecognizer) {
    ...
    // private makes object itself could access and modify the method
    // animationnDuration & completioon are optional
  ...
  // Exercise     : Implement `resetKarts` to reset the size and positioning of the karts
    // Long press the background to reset.
